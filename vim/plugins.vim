...
call plug#begin(expand(s:home . '/plugins'))
...
" a qucikly run code plug
" you can use replace AsyncRun -raw python3 xxx.py with Sprint - a shorter commond
Plug 'pedsm/sprint'
...
"----------------------------------------------------------------------
"ctrlp lf暂时不支持多文件的关键词搜索，这里可以考虑用支持ripgrep的ctrlp来完成
"----------------------------------------------------------------------
Plug 'kien/ctrlp.vim'
"<Leader>p搜索当前目录下文件
...
"Plug 'Valloric/YouCompleteMe'           "complete utils
...
let g:UltiSnipsSnippetsDir = s:home . "/UltiSnips"
let g:UltiSnipsSnippetDirectories=[s:home . "/UltiSnips"]
let g:snips_author = 'Raymond'
